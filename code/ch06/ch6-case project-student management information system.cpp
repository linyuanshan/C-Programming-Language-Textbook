...
// 1.学生成绩录入
int InputScores(int scores[][5], int stu_num){
...
// 2.学生成绩输出
void OutputScores(int scores[][5], int stu_num){
	int i, j;
	if(stu_num==0)
		printf("没有成绩数据！\n");
	else
...
// 3.学生成绩查询
void Inquiry(int scores[][5], int stu_num){
	int i, j;
	int id;
	if(stu_num==0)
		printf("没有成绩数据！\n");
...
// 4.学生成绩统计
void AnalyzeScores(int scores[][5], int stu_num){
...
// 5.学生成绩排名
void SortByScores(int scores[][5], int stu_num){
	int i, j, k;
	if(stu_num==0)
		printf("没有成绩数据！\n");
	else
...
// 6.删除某个学生成绩
int DeleteById(int scores[][5], int stu_num){
	int i, j, k, id;
	if(stu_num==0)
		printf("没有成绩数据！\n");
	else
...
// 7.学生成绩修改
void ModifyById(int scores[][5], int stu_num){
	int i;
	int id, math, English, clanguage;
	if(stu_num==0)
		printf("没有成绩数据！\n");
	else
	{
...
// 8.成绩按学号排序
void SortByIds(int scores[][5], int stu_num){
	int i, j, k;
	if(stu_num==0)
		printf("没有成绩数据！\n");
	else
...
int main(){
	...
	while(1)
	{
		...
		case 1:
			printf("*****************1、成绩录入******************\n");
			stu_num = InputScores(scores, stu_num);
			break;
		case 2:
			printf("*****************2、成绩输出******************\n");
			OutputScores(scores, stu_num);
			break;
		case 3:
			printf("*****************3、成绩查询******************\n");
			Inquiry(scores, stu_num);
			break;
		case 4:
			printf("*****************4、成绩统计******************\n");
			AnalyzeScores(scores, stu_num);
			break;
		case 5:
			printf("*****************5、成绩排名******************\n");
			SortByScores(scores, stu_num);
			break;
		case 6:
			printf("*****************6、成绩删除******************\n");
			stu_num = DeleteById(scores, stu_num);
			break;
		case 7:
			printf("*****************7、成绩修改******************\n");
			ModifyById(scores, stu_num);
			break;
		case 8:
			printf("*****************8、成绩按学号排序************\n");
			SortByIds(scores, stu_num);
			break;
		}
	}
	return 0;
